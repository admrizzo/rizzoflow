...
export const FIELD_CATALOG: Record<CorrectionStep, FieldDef[]> = {
  personal: [
    ...
    { key: 'profissao', label: 'Profissão / Ocupação', action: 'edit_field', parties: ['locatario_principal', 'locatario_adicional', 'conjuge', 'fiador'] },
    { key: 'renda', label: 'Renda', action: 'edit_field', parties: ['locatario_principal', 'locatario_adicional', 'conjuge', 'fiador'] },
    { key: 'fonte_renda', label: 'Fonte de renda', action: 'edit_field', parties: ['locatario_principal', 'locatario_adicional', 'fiador'] },
