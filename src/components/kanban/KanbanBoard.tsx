...
import { CardWithRelations, Board, Column } from '@/types/database';
        ...
        <Droppable droppableId="board" type="column" direction="horizontal">
          {(provided) => (
            <div
              ...
              className="flex gap-4 p-4 sm:p-6 overflow-auto min-h-[calc(100vh-10rem)] cursor-grab select-none lp-thin-scroll scrollbar-none bg-background/50"
