         ...
         <div className="flex-shrink-0">
           {profile ? (
             <Avatar className="h-9 w-9 border-2 border-white shadow-sm">
               {profile.user_id && profiles.find(p => p.user_id === profile.user_id)?.avatar_url && (
                 <AvatarImage src={profiles.find(p => p.user_id === profile.user_id)?.avatar_url!} alt={profile.full_name} />
               )}
